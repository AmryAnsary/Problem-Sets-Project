...
# Load AHTN data for 2017 and 2022 (assuming data is in CSV format)
...
def find_closest_ahtn_2017(ahtn_2022_code, ahtn_2022_desc, top_n=3):
    ...
    for _, row in ahtn_2017.iterrows():
        ahtn_2017_code = str(row['Code']) if row['Code'] is not None else ""  # Update to your column name if different
        ahtn_2017_desc = str(row['Description']) if row['Description'] is not None else ""  # Update to your column name if different
